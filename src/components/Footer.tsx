  ...
  return (
    ...
    >
      <div className="container-edge py-20 md:py-28">
        ...
        {/* Bottom bar */}
        <div className="mt-20 flex flex-col items-start justify-between gap-4 border-t border-hairline pt-8 pb-6 text-mono-label text-smoke md:flex-row md:items-center">
